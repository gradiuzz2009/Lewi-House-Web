  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-16 animate-fadeIn">
      ...
      <div className="space-y-4 max-w-3xl">
        <div className="inline-flex items-center gap-2 bg-emerald-50 text-emerald-800 border border-emerald-200/80 px-3.5 py-1 rounded-full text-xs font-bold tracking-wide">
      ...
      <div className="bg-gradient-to-r from-amber-500/10 via-amber-50 to-orange-50 rounded-3xl p-6 sm:p-8 border border-amber-200 shadow-xs flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
      ...
      <div className="bg-[#1A365D] text-white rounded-3xl p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div>
          ...
          <p className="text-xs text-slate-300 mt-1">Our front desk team is happy to assist you anytime via WhatsApp or Phone.</p>
        </div>
        <a
          href={HOTEL_INFO.whatsappUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-6 py-3 rounded-xl text-xs flex items-center gap-2 shadow-md transition-all whitespace-nowrap"
        >
